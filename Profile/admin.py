...
class SavedVehicleAdmin(admin.ModelAdmin):
    ...
    list_filter = ['user', 'saved_at', 'vehicle__uploader']  # Added filter by uploader
...
class UploadedVehicleAdmin(admin.ModelAdmin):
    ...
    list_filter = ['uploader', 'is_rental', 'fuel_type', 'transmission', 'type_of_vehicle']  # Added more filters
